...
class ScheduleControllerTest {
    ...
    void updateScheduleSuccess() throws Exception {
        ...
        Optional<Schedule> schedule = scheduleRepository.findById("ef20cc66-2f9d-469f-97e4-2d530b682631");
        ...
        ScheduleRequest scheduleRequest = ScheduleRequest.builder()
                ...
                .classes_id("22b16c19-3b11-42bb-ae94-ca67271f9a9a")
                .build();
        log.info(scheduleRequest.getId());
        log.info(scheduleRequest.getMeeting_link());
        log.info(String.valueOf(scheduleRequest.getStart_class()));
        log.info(String.valueOf(scheduleRequest.getEnd_class()));
        log.info(scheduleRequest.getClasses_id());
